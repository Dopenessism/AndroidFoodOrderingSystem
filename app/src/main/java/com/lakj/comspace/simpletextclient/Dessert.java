...
public class Dessert extends Activity {
    ...
    public void bubble_tea_inc(View view) {
        bubble_tea = inc(bubble_tea);
        TextView tv = (TextView) findViewById(R.id.falooda_order);
        tv.setText("" + bubble_tea);
        total_cal();
    }

    public void bubble_tea_dec(View view) {
        if (bubble_tea >= 0) {
            bubble_tea = dec(bubble_tea);
            TextView tv = (TextView) findViewById(R.id.falooda_order);
            if (bubble_tea > 0) tv.setText("" + bubble_tea);
            else tv.setText("__");
            total_cal();
    ...
    public void total_cal() {
        dessert_total = chocolate_ice_cream * (80) + vanilla_ice_cream * (70) + strawberry_ice_cream * (75) + bubble_tea * (150) + brownie_fudge * (120) + alpine_chocolate * (150) + devils_delight * (100) + black_forest * (80) + chocolate_lava * (180) + dutch_almond * (120);
